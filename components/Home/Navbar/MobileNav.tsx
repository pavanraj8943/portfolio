...
const MobileNav = ({ closeNav, showNav }: Props) => {
    ...
    return (
        <div>
            {/* overlay */}
            <div
                className={`fixed inset-0 ${navOpen} transform transition-all right-0 duration-500 z-[1000] bg-black
        ...
        duration-500 delay-300 w-[80%] sm:w-[60%] bg-cyan-900 space-y-6 z-[1000] right-0`}
            >
                {NavLinks.map((link) => {
                    return (
